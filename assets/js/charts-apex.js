...
barChartr.render();
  ...
  if (typeof barChartEls !== undefined && barChartEls !== null) {
    const barCharts = new ApexCharts(barChartEls, barChartConfigs);
    barCharts.render();
  }
  ...
  horizontalBarChartConfig = {
    ...
    colors: ["#28c76f", "#FFEB3B", "#DC3545", "#17A2B8", "#6610F2", "#6F42C1", "#E83E8C"],
    series: [{
     
      data: [
        { x: 'Category 1', y: 35, fillColor: '#6F42C1' },
        { x: 'Category 2', y: 20, fillColor: '#17A2B8' },
        { x: 'Category 3', y: 14, fillColor: '#28c76f' },
        { x: 'Category 4', y: 12, fillColor: '#17A2B8' },
        { x: 'Category 6', y: 9, fillColor: '#DC3545' },
        { x: 'Category 7', y: 21, fillColor: '#FFEB3B' }
      ]
    }],
    xaxis: {
...
// Horizontal Bar Chart2
  // --------------------------------------------------------------------
  const horizontalBarChartEls = document.querySelector('#horizontalBarCharts'),
    horizontalBarChartConfigs = {
      chart: {
        height: 400,
        type: 'bar',
        stacked: true,
  ...
  if (typeof horizontalBarChartEls !== undefined && horizontalBarChartEls !== null) {
  ...
  const radialBarChartEl = document.querySelector('#radialBarChart'),
    radialBarChartConfig = {
      ...
      series: [80, 50, 35],
      labels: ['المشتريات', 'المبيعات', 'المتبقى']
  ...
  // Radar Chart
   // Radial Bar Chart2
  // --------------------------------------------------------------------
  const radialBarChartElr = document.querySelector('#radialBarCharts'),
    radialBarChartConfigr = {
      chart: {
        height: 380,
        type: 'radialBar'
      },
  ...
  if (typeof radialBarChartElr !== undefined && radialBarChartElr !== null) {
    const radialChartr = new ApexCharts(radialBarChartElr, radialBarChartConfigr);
    radialChartr.render();
  }
  ...
  // --------------------------------------------------------------------
  const donutChartEles = document.querySelector('#donutCharte-sub'),
    donutChartConfiges = {
      chart: {
        height: 390,
        type: 'donut'
  ...
  if (typeof donutChartEles !== undefined && donutChartEles !== null) {
    const donutChartes = new ApexCharts(donutChartEles, donutChartConfiges);
    donutChartes.render();
  }
  // --------------------------------------------------------------------
    // Donut Chart-customer
  // --------------------------------------------------------------------
  const donutChartElesc = document.querySelector('#donutCharte-custemer'),
    donutChartConfigesc = {
      chart: {
        height: 390,
        type: 'donut'
  ...
  if (typeof donutChartElesc !== undefined && donutChartElesc !== null) {
    const donutChartesc = new ApexCharts(donutChartElesc, donutChartConfigesc);
    donutChartesc.render();
  }
})();
